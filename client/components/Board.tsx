...
export default function Board({ G, moves, playerID, matchID, isActive }: Props) {
  ...
  // HowToPlayDialog restores focus to whatever was active when it opened, so
  // no trigger ref is needed here.
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-black text-white">
      ...
      {/* HOW TO PLAY — one source of truth, shared with the homepage. */}
